<?php
	...
	*/
	...
	$Form->elements(
		...
		array(
			'admin_action' => array(
				...
				'error' => 'Ваши настройки были обновлены.'
			)
		)
	);
	...
	$Form->elements(
		...
		array(
			'submit' => array(
				'type' => 'submit', 'value' => 'Сохранить', 'label' => ''
			),
		)
	);
		...
		?>
			...
			<div class="right">
				<div class="idesigneco">
					<a href="http://idesigneco.com"><img src="<?php echo IDE_ADMIN_STATIC.'/idesigneco.png'; ?>" alt="Тема от iDesignEco" title="Тема от iDesignEco" /></a>
				</div>
				<div class="news">
