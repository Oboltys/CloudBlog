...
<body <?php echo body_class( ide_body_class() ); ?>>
<div id="wrap">
	<div id="header">
		<div class="logo">
		...
		<div class="options">
			<form class="searchform" method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>">
				<div>
					<input type="text" name="s" class="input" value="<?php _e('поиск'); ?>" onfocus="javascript:(this.value == '<?php _e('поиск'); ?>' ? this.value = '' : null );" />
				</div>
			</form>
		</div><!-- options //-->
		<div class="clear"> </div>
